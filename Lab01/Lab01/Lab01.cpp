...
*
* Lab/Assignment: Lab 1 - Arrays
*
* Overview: This lab goes pver arrays
*
* Input: Has a string of names that will 
*		 go through a series of test
*
* Output: It will say if it passed or failed
**************************************************/
...
FunctionPointer test_functions[] = { test_neg_length, test_lower_bounds,
test_upper_bounds,
test_2_arg_ctor,
test_1_arg_ctor, test_default_ctor,
test_set_pos_start_index,
test_set_neg_start_index,
test_adding_values,
test_larger_length_with_data,
test_smaller_length_with_data, test_set_start_index_with_data,
test_copy_ctor, test_op_eql,
test_neg_length_complex,
test_lower_bounds_complex,
test_upper_bounds_complex,
test_2_arg_ctor_complex,
test_1_arg_ctor_complex, test_default_ctor_complex,
test_set_pos_start_index_complex, test_set_neg_start_index_complex,
test_adding_values_complex,
test_larger_length_with_data_complex,
test_smaller_length_with_data_complex,
test_set_start_index_with_data_complex,
