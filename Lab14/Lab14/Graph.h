...
* Modifications:   May 29thth 2025
*                  Finished Traversal Methods
*                  Added SetVectors method to help
*                  with Dijksta's Algorithm
*
* Class: Graph
*
...
public:
    ...
    void InsertEdge(V from, V to, E edgeData, int weight);
    void DeleteEdge(V from,  V to);
    void DepthFirst(void (*visit)(V data));
    void BreadthFirst(void (*visit)(V data));
    bool isEmpty() const;
    void SetVectors(vector<Vertex<V, E>*>& data);
private:
    Vertex<V, E>* FindVertex(const V& data);
...
**************************************************/
template<typename V, typename E>
void Graph<V, E>::InsertEdge(V from, V to, E edgeData, int weight)
{
...
// Set Vectors Function
/*************************************************
* Purpose: helps set vectors
*
* Precondtions: vertex contents
*
* Postconditions: vectors are set
*
**************************************************/
template<typename V, typename E>
void Graph<V, E>::SetVectors(vector<Vertex<V, E>*>& array)
{
    for (typename list<Vertex<V, E>>::iterator it = vertices.begin(); it != vertices.end(); it++)
    {
        Vertex<V, E>& temp = *it;
