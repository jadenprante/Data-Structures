...
* 
* 
* Lab/Assignment: Lab 3 – 2D-Array Implementation 1
*
* Overview:
...
FunctionPointer test_functions[] = { test_neg_row, test_neg_col,
test_upper_bounds_row, test_upper_bounds_col,
test_default_ctor,
test_2_arg_ctor, test_set_row, test_set_col,
test_add_data,
test_copy_ctor, test_op_eql, test_increase_rows_with_data,
test_decrease_rows_with_data,
test_increase_cols_with_data, test_decrease_cols_with_data,
test_neg_row_complex,
test_neg_col_complex, test_upper_bounds_row_complex ,
test_upper_bounds_col_complex, test_default_ctor_complex,
test_2_arg_ctor_complex,
test_set_row_complex, test_set_col_complex,
test_add_data_complex,
test_copy_ctor_complex, test_op_eql_complex, test_increase_rows_with_data_complex,
test_decrease_rows_with_data_complex, test_increase_cols_with_data_complex,
test_decrease_cols_with_data_complex };
int main()
{
