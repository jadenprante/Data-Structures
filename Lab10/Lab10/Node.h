...
* Author:          Jaden Prante
* File Name:       List.h
* Date Created:    Jan 10th 2025
* Modifications:   Jan 11th 2025
*                  Reworked Manager functions to act accordingly
*				   Rearranged code to look more presentable
*				   Moved Getters and Setters to be or organized
**************************************************/
#pragma once
#include <iostream>
